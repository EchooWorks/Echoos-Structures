...
execute as @s if predicate echoo_structure:nether_fortress/wither_hound_idle_sound_chance run execute at @s run playsound echoo_structure:entity.wither_hound.idle hostile @a[distance=..12]